...
<div class="wrapper">
    ...
    <!--菜单回显-->
<%--    <c:set var="currentMenu" value="teacher/vourse"/>--%>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box">
                <!--高级查询--->
                <form class="form-inline" id="searchForm" action="/teacher/course/listPage" method="post">
                    <input type="hidden" name="currentPage" id="currentPage" value="1">
                    <a href="/teacher/course/input" class="btn btn-success btn-input" style="margin: 10px">
                ...
                <div class="box-body table-responsive no-padding ">
                    <table class="table table-hover table-bordered">
                        ...
                        <c:forEach items="${pageResult.data}" var="course" varStatus="vs">
                            <tr>
                                <td>${vs.count}</td>
                                <td>${course.name}</td>
                                ...
                                <td>${course.count}</td>
                                <td>
                                    <a href="/teacher/course/input?id=${course.id}" class="btn btn-info btn-xs btn-input">
